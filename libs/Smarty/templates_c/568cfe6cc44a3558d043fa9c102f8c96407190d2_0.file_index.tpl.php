<?php
/* Smarty version 5.5.1, created on 2025-06-30 15:35:26
  from 'file:utente/template_esempio/index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_6862929eecb974_99957568',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '568cfe6cc44a3558d043fa9c102f8c96407190d2' => 
    array (
      0 => 'utente/template_esempio/index.tpl',
      1 => 1751290523,
      2 => 'file',
    ),
  ),
...
function content_6862929eecb974_99957568 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\Casette_Dei_Desideri\\libs\\Smarty\\templates\\utente\\template_esempio';
?><!DOCTYPE html>
<html lang="en">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="/Casette_Dei_Desideri/public/assets/images/featured.jpg" alt="">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/featured-icon.png" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
        ...
        <div class="col-lg-3">
          <div class="info-table">
            <ul>
              <li>
                <img src="/Casette_Dei_Desideri/public/assets/images/info-icon-01.png" alt="" style="max-width: 52px;">
                <h4>250 m2<br><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="/Casette_Dei_Desideri/public/assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                <h4>Contract<br><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="/Casette_Dei_Desideri/public/assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                <h4>Payment<br><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="/Casette_Dei_Desideri/public/assets/images/info-icon-04.png" alt="" style="max-width: 52px;">
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="video-frame">
            <img src="/Casette_Dei_Desideri/public/assets/images/video-frame.jpg" alt="">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-02.jpg" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-03.jpg" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-04.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-05.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="/Casette_Dei_Desideri/public/assets/images/property-06.jpg" alt=""></a>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item phone">
                <img src="/Casette_Dei_Desideri/public/assets/images/phone-icon.png" alt="" style="max-width: 52px;">
                <h6>010-020-0340<br><span>Phone Number</span></h6>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item email">
                <img src="/Casette_Dei_Desideri/public/assets/images/email-icon.png" alt="" style="max-width: 52px;">
